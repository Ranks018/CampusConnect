...
<body>
  ...
  <div class="container" style="margin-top: 50px;">
    ...
    <div class="col-md-9 " style="margin-top: 5px;">
        <h1 style="color: purple;"><a class="nav-link" href="../Super Admin/SuperAdminHomepage.php">
  ...
  <div class="footer-copyright py-3">
    ...
    <div class="row">
      ...
      <div class="col-md-10" style="text-align: left; padding-left: 0px;">
        <a class="nav-link" style="width: 2%;" href="../Super Admin/SuperAdminHomepage.php">CampusConnectNWU.com</a>        
      </div>
    </div> 
