...
<body>
  ...
  <div class="container" style="margin-top: 50px;">
    ...
    <div class="row " style="background-color: #F5E6FF; margin-top: 20px; height: 150px;">
      <div class="col-md-9 " style="margin-top: 5px;">
        <h1 style="color: purple;" ><a class="nav-link"  href="/Online News Portal/Public/Homepage.php">
        ...
        <ul class="navbar-nav mr-auto">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <a class="dropdown-item" href="/Online News Portal/Public/PublicAnnouncementPage.php">Announcement</a>
              <a class="dropdown-item" href="/Online News Portal/Public/PublicWebinarsPage.php">Webinars</a>
              <a class="dropdown-item" href="/Online News Portal/Public/PublicSeminarPage.php">Seminar</a>
              <a class="dropdown-item" href="/Online News Portal/Public/PublicSportsPage.php">Sports</a>
              <a class="dropdown-item" href="/Online News Portal/Public/PublicEntertainmentPage.php">Entertainment</a>
              <a class="dropdown-item" href="/Online News Portal/Public/PublicLifestylePage.php">Lifestyle</a>
              <a class="dropdown-item" href="/Online News Portal/Public/PublicNewsPage.php">News</a>
            </div>
  ...
  <div class="container" style="margin-top: 80px; width: 60%;">
    ...
    date_default_timezone_set("Africa/Johannesburg");
    $Date = date("d/m/Y");
    $sql = "SELECT * FROM news WHERE NewsDate='$Date' and NewsCategory='News' order by NewsTimeForSort desc";
            ...
            <div class="row">
              ...
              <div class="col-md-8 bg-white" style="margin-left: 1px;">
                <a class="nav-link" href="/Online News Portal/Public/PublicSinglePageNewsViewModule.php?var=<?php echo $NewsId; ?>" style="padding-left: 0px;">
                  ...
                  <font size="3px">
                    <font color="DimGray"><?php echo substr($NewsDescription, 0, 138); ?>...</font>
                  </font><br>
                </a>
                <font size="1px">
                  <font color="Darkgray">Published : <?php echo $NewsTime ?></font>
                </font><br><br>
              </div>
            </div>
          </div>
  ...
  <footer class="page-footer container " style="background-color: #F5E6FF; margin-top: 70px; margin-bottom: 30px;">
    ...
    <center>
      <font size="2"><a class="nav-link" style="width: 20%;" href="/Online News Portal/Super Admin/SuperAdminSignIn.php"><b>Super Administrator</b></a> </font>
    </center>
    ...
    <div class="footer-copyright py-3">
      ...
      <div class="row">
        ...
        <div class="col-md-10" style="text-align: left; padding-left: 0px;">
          <a class="nav-link" style="width: 2%;" href="/Online News Portal/Public/Homepage.php">CampusConnectNWU.com</a>
        </div>
      </div>
