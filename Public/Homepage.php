  ...
  <div class="container" style="margin-top: 50px;">
    ...
    <div class="row " style="background-color: #F5E6FF; margin-top: 20px; height: 150px;">
      ...
      <div class="col-md-3" style="margin-top: 20px; text-align: right;">
        ...
        <a href="../Viewer/ViewerSignUp.php"><button class="btn btn-outline-dark" type="submit" style="margin-left: 15px;">Sign Up</button></a>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <a class="btn" data-toggle="collapse" href="#myContent" style="margin-top: -7px;"><img src="../Images/SearchIcon.PNG" style="height: 25px; width: 25px;"></a>
        <div class="collapse" id="myContent">
          <div>
            <form action="../ConnectSearch.php" method="Post">
        ...
        <div class="modal-content">
          <div class="modal-body">
            ...
            <div class="container" style="width: 50%;">
              <form action="../Viewer/ConnectViewerSignIn.php" method="Post">
                <br>
                ...
                <a href="../Viewer/ViewerSignUp.php" style="text-decoration: none; color: black; font-size: 3;">Create an account?</a>
                <br>
          ...
          <div class="card-body bg-light">
            <div class="row">
              <div class="col-md-3">
                ...
                if (isset($NewsImage)) {
                ?>
                  <a href="../Public/PublicSinglePageNewsViewModule.php?var=<?php echo $NewsId; ?>"><img src="../Images/<?php echo $NewsImage ?>" alt="Image is not available" style=" width: 100%; height: 200px;"></a>
                <?php
                  unset($NewsImage);
                }
                ?>
              ...
              <div class="col-md-8 bg-white" style="margin-left: 1px;">
                <a class="nav-link" href="../Public/PublicSinglePageNewsViewModule.php?var=<?php echo $NewsId; ?>" style="padding-left: 0px;">
